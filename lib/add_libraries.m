function [] = add_libraries(varargin)
% Description:
%	Includes different libraries, if the user did not already properly include the right toolboxes.
%
% Inputs:
...
if nargin == 0
	warning('No toolbox/library names were given as input. Doing nothing.')
end
